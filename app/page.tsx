...
function buildStyles(theme: BudgetTheme, darkMode: boolean): Record<string, React.CSSProperties> {
  ...
  tipsWrap:      { marginTop: "1.25rem", background: theme.bgSecondary, borderWidth: 1, borderStyle: "solid", borderColor: theme.border, borderRadius: 10, overflow: "hidden" },
  ...
  tipsIcon:      { fontSize: 18, fontWeight: 700, color: theme.text, lineHeight: 1, minWidth: 14, textAlign: "center" as const },
  tipsPanel:     { padding: "0 14px 12px" },
  tipsSection:   { marginBottom: 12 },
  tipsSectionTitle: { fontSize: 13, fontWeight: 600, color: theme.text, marginBottom: 6, fontFamily: "monospace" },
  tipsList:      { listStyle: "disc", paddingLeft: 20, margin: 0, display: "flex", flexDirection: "column", gap: 4, color: theme.textMuted },
